...
Gradle:
```groovy
debugCompile 'com.ashokvarma.android:sharedpref-manager:0.9.2'
releaseCompile 'com.ashokvarma.android:sharedpref-manager-no-op:0.9.2'
```
...
or Ivy:
```xml
<dependency org='com.ashokvarma.android' name='sharedpref-manager' rev='0.9.2'>
