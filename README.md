...
Gradle:
```groovy
debugCompile 'com.ashokvarma.android:sharedpref-manager:0.9.1'
releaseCompile 'com.ashokvarma.android:sharedpref-manager-no-op:0.9.1'
```
If you want this in library in production also then try this : 
```groovy
compile 'com.ashokvarma.android:sharedpref-manager:0.9.1'
```
...
or Ivy:
```xml
<dependency org='com.ashokvarma.android' name='sharedpref-manager' rev='0.9.1'>
